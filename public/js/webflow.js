...
! function (t) {
    ...
    i.resize = E(u, k), i.scroll = E(u, "scroll.webflow resize.webflow orientationchange.webflow load.webflow"), i.redraw = E(), i.location = function (t) {
        ...
        t = t || {}, p = !0, u.triggerHandler("__wf_destroy"), null != t.domready && (d = t.domready), f.each(r, m), i.resize.off(), i.scroll.off(), i.redraw.off(), o = [], a = [], "pending" === _.state() && A()
    ...
    window.tram = function (t) {
        ...
        S.transform && (Y.transform = [F], K = {
            ...
            skewX: [_],
            skewY: [_]
        }), S.transform && S.backface && (K.z = [x, "translateZ"], K.rotateZ = [_], K.scaleZ = [g], K.perspective = [y]);
        var Q = /ms/,
            V = /s|\./;
        return t.tram = e
    }(window.jQuery)
    ...
    i.define("navbar", t.exports = function (t, e) {
        ...
        function A(n, i) {
            ...
            c && "/" === c.attr("href") && null == c.attr("aria-label") && c.attr("aria-label", "home"), a.button.attr("style", "-webkit-user-select: text;"), null == a.button.attr("aria-label") && a.button.attr("aria-label", "menu"), a.button.attr("role", "button"), a.button.attr("tabindex", "0"), a.button.attr("aria-controls", a.overlayContainerId), a.button.attr("aria-haspopup", "menu"), a.button.attr("aria-expanded", "false"), a.el.off(m), a.button.off(m), a.menu.off(m), T(a), s ? (R(a), a.el.on("setting" + m, function (t) {
                return function (n, i) {
                    i = i || {};
                    var r = f.width();
                    T(t), !0 === i.open && $(t, !0), !1 === i.open && F(t, !0), t.open && e.defer(function () {
                        r !== f.width() && S(t)
                    })
                }
            }(a))) : (! function (e) {
            ...
            }(a), a.button.on("click" + m, I(a)), a.menu.on("click" + m, "a", M(a)), a.button.on("keydown" + m, function (t) {
                return function (e) {
                    switch (e.keyCode) {
                        case o.SPACE:
                        case o.ENTER:
        ...
        c.ready = c.design = c.preview = function () {
            ...
            k = t(), E(), a && a.length && a.each(C)
        };
        var D = d(function (t, e) {
            if (t.open) {
        ...
        function F(t, e) {
            ...
            function u() {
                t.menu.height(""), l(t.menu).set({
                    x: 0,
                    y: 0
                }), t.menu.each(q), t.links.removeClass(x), t.dropdowns.removeClass(g), t.dropdownToggle.removeClass(b), t.dropdownList.removeClass(y), t.overlay && t.overlay.children().length && (k.length ? t.menu.insertAfter(k) : t.menu.prependTo(t.parent), t.overlay.attr("style", "").hide()), t.el.triggerHandler("w-close"), t.button.attr("aria-expanded", "false")
            }
        }
        return c
    })
